...
$sql = "SELECT * FROM peminjaman INNER JOIN detail_pinjam ON peminjaman.id_pinjam=detail_pinjam.id_pinjam INNER JOIN buku ON buku.id_buku=detail_pinjam.id_buku WHERE peminjaman.id_pinjam='$id_pinjam'";
			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="text-rigth" colspan="2">
						...
						<a class="btn btn-primary<?php if($detail['tgl_kembali']!=NULL){echo "disabled";}?>" href="form-kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>" role="button">Form Pengembalian<i class="fas fa-angle-double-right"></i></a>
					</td>
				</tr>
			</table>
		</div>
